...
/* Command for C compiler:
   gcc -c  -w  -I/home/dustin/Documents/Nim/lib -o /home/dustin/Documents/Nim_Projects/VectorGuy/src/nimcache/stdlib_parseutils.o /home/dustin/Documents/Nim_Projects/VectorGuy/src/nimcache/stdlib_parseutils.c */
...
N_LIB_PRIVATE N_NIMCALL(NI, npuParseInt)(NimStringDesc* s, NI* number, NI start) {
	...
	result = (NI)0;
	res = (NI64)0;
	nimln_(266, "parseutils.nim");
	result = npuParseBiggestInt(s, (&res), start);
	nimln_(267, "parseutils.nim");
	{
		NIM_BOOL T3_;
		NIM_BOOL T5_;
	...
	{
		nimln_(400, "system.nim");
		nimln_(270, "parseutils.nim");
		if (!!((result == ((NI) 0)))) goto LA11_;
		nimln_(271, "parseutils.nim");
		(*number) = ((NI) (res));
	}
	goto LA1_;
	LA11_: ;
