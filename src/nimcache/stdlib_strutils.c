...
/* Command for C compiler:
   gcc -c  -w  -I/home/dustin/Documents/Nim/lib -o /home/dustin/Documents/Nim_Projects/VectorGuy/src/nimcache/stdlib_strutils.o /home/dustin/Documents/Nim_Projects/VectorGuy/src/nimcache/stdlib_strutils.c */
...
STRING_LITERAL(TM_JGc9b9bh2D3nTdUR7TGyq8aA_7, "invalid integer: ", 17);
...
{	result = (NI)0;
	...
	m = (((a ? a->Sup.len : 0) <= (b ? b->Sup.len : 0)) ? (a ? a->Sup.len : 0) : (b ? b->Sup.len : 0));
	{
		...
		while (1) {
			...
			TM_JGc9b9bh2D3nTdUR7TGyq8aA_4 = subInt(((NU8)(T3_)), ((NU8)(T4_)));
			result = (NI)(TM_JGc9b9bh2D3nTdUR7TGyq8aA_4);
			nimln_(254, "strutils.nim");
			{
				nimln_(400, "system.nim");
				nimln_(254, "strutils.nim");
			...
			LA7_: ;
			nimln_(255, "strutils.nim");
			TM_JGc9b9bh2D3nTdUR7TGyq8aA_5 = addInt(i, ((NI) 1));
			i = (NI)(TM_JGc9b9bh2D3nTdUR7TGyq8aA_5);
		} LA2: ;
	}
	nimln_(256, "strutils.nim");
	TM_JGc9b9bh2D3nTdUR7TGyq8aA_6 = subInt((a ? a->Sup.len : 0), (b ? b->Sup.len : 0));
	result = (NI)(TM_JGc9b9bh2D3nTdUR7TGyq8aA_6);
	}BeforeRet_: ;
	popFrame();
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(void, nsuRemoveSuffixCharSet)(NimStringDesc** s, tySet_tyChar_nmiMWKVIe46vacnhAFrQvw chars) {
	...
	nimfr_("removeSuffix", "strutils.nim");
{	nimln_(2284, "strutils.nim");
	{
		if (!(((*s) ? (*s)->Sup.len : 0) == ((NI) 0))) goto LA3_;
		goto BeforeRet_;
	}
	LA3_: ;
	nimln_(2285, "strutils.nim");
	last = ((*s) ? ((*s)->Sup.len-1) : -1);
	{
		nimln_(2286, "strutils.nim");
		while (1) {
			NIM_BOOL T7_;
			...
			T7_ = (((NI) -1) < last);
			if (!(T7_)) goto LA8_;
			if (!(*s) || (NU)(last) >= (NU)((*s)->Sup.len)) raiseIndexError();
			T7_ = ((chars[(NU)(((NU8)((*s)->data[last])))>>3] &(1U<<((NU)(((NU8)((*s)->data[last])))&7U)))!=0);
			LA8_: ;
			if (!T7_) goto LA6;
			TM_JGc9b9bh2D3nTdUR7TGyq8aA_8 = subInt(last, ((NI) 1));
			last = (NI)(TM_JGc9b9bh2D3nTdUR7TGyq8aA_8);
		} LA6: ;
	}
	nimln_(2287, "strutils.nim");
	TM_JGc9b9bh2D3nTdUR7TGyq8aA_9 = addInt(last, ((NI) 1));
	(*s) = setLengthStr((*s), ((NI)chckRange((NI)(TM_JGc9b9bh2D3nTdUR7TGyq8aA_9), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	}BeforeRet_: ;
	popFrame();
}
...
N_LIB_PRIVATE N_NIMCALL(void, nsuRemovePrefixCharSet)(NimStringDesc** s, tySet_tyChar_nmiMWKVIe46vacnhAFrQvw chars) {
	NI start;
	nimfr_("removePrefix", "strutils.nim");
	nimln_(2331, "strutils.nim");
	start = ((NI) 0);
	{
		nimln_(2332, "strutils.nim");
		while (1) {
			NIM_BOOL T3_;
			NI TM_JGc9b9bh2D3nTdUR7TGyq8aA_10;
			T3_ = (NIM_BOOL)0;
			T3_ = (start < ((*s) ? (*s)->Sup.len : 0));
			if (!(T3_)) goto LA4_;
			if (!(*s) || (NU)(start) >= (NU)((*s)->Sup.len)) raiseIndexError();
			T3_ = ((chars[(NU)(((NU8)((*s)->data[start])))>>3] &(1U<<((NU)(((NU8)((*s)->data[start])))&7U)))!=0);
			LA4_: ;
			if (!T3_) goto LA2;
			TM_JGc9b9bh2D3nTdUR7TGyq8aA_10 = addInt(start, ((NI) 1));
			start = (NI)(TM_JGc9b9bh2D3nTdUR7TGyq8aA_10);
		} LA2: ;
	}
	nimln_(2333, "strutils.nim");
	{
		NI TM_JGc9b9bh2D3nTdUR7TGyq8aA_11;
		if (!(((NI) 0) < start)) goto LA7_;
		TM_JGc9b9bh2D3nTdUR7TGyq8aA_11 = subInt(start, ((NI) 1));
		nsuDelete(s, ((NI) 0), (NI)(TM_JGc9b9bh2D3nTdUR7TGyq8aA_11));
	}
	LA7_: ;
	popFrame();
}
