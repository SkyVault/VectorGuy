...
/* Command for C compiler:
   gcc -c  -w  -I/home/dustin/Documents/Nim/lib -o /home/dustin/Documents/Nim_Projects/VectorGuy/src/nimcache/stdlib_unicode.o /home/dustin/Documents/Nim_Projects/VectorGuy/src/nimcache/stdlib_unicode.c */
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, nuctoUTF8)(NI32 c) {
	...
	LA3_: ;
	{
		...
		if (!result || (NU)(((NI) 1)) >= (NU)(result->Sup.len)) raiseIndexError();
	...
	LA6_: ;
	{
		...
		if (!result || (NU)(((NI) 2)) >= (NU)(result->Sup.len)) raiseIndexError();
	...
	LA9_: ;
	{
		...
		if (!result || (NU)(((NI) 3)) >= (NU)(result->Sup.len)) raiseIndexError();
	...
	LA12_: ;
	{
		...
		if (!result || (NU)(((NI) 4)) >= (NU)(result->Sup.len)) raiseIndexError();
	...
	LA15_: ;
	{
		...
		if (!result || (NU)(((NI) 5)) >= (NU)(result->Sup.len)) raiseIndexError();
